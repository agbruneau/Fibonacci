...
### Performance
*   [ ] **Speed**: The Rust implementation consistently outperforms the Go binary in benchmarks for $N > 10,000,000$ (strictly faster execution time).
*   [ ] **Memory**: Demonstrates efficient memory usage, ideally lower or comparable to the Go version's optimized usage.
