...
~87.5% coverage across unit, integration, fuzz, property, and end-to-end tests.
...
Five fuzz targets in `internal/fibonacci/fibonacci_fuzz_test.go`: `FuzzFastDoublingConsistency`, `FuzzFFTBasedConsistency`, `FuzzFibonacciIdentities`, `FuzzProgressMonotonicity`, `FuzzFastDoublingMod`.
