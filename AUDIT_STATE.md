...
- [ ] Comparer baseline mesurée vs référence 2026-06-09 (sanité env.)
- [x] Profilage cpu/mem capturé : `cpu_fd10m.prof`/`mem_fd10m.prof` (binaire `fib10m.test`), `cpu_fd1m.prof`/`mem_fd1m.prof` (`fib1m.test`) — analyse pprof en cours
